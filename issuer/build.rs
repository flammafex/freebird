...
//!
//! This ensures the unified admin UI is embedded in the issuer binary.
//! Both issuer and verifier share the same admin UI source, which adapts
//! based on the detected service type at runtime.
