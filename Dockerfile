...
# Build issuer operational binaries with optimizations
...
RUN mkdir -p /data/config /data/keys /data/state && \
    chown -R 1000:1000 /data && \
    chmod 750 /data /data/config /data/keys /data/state
